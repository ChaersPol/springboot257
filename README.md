...
## 本项目获取地址：https://www.bishecode.com/product/253/
...
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图展示的就是管理员功能结构图，管理员在后台主要管理字典管理、工程安排管理、合同管理、售后服务管理、用户管理、预算管理、装修风格管理、装修风格收藏管理、装修风格留言管理、主材管理、主材收藏管理、主材留言管理、管理员管理等。

![alt text](images/image-2.png)

# 五、效果图展示【部分效果图】

图5.1 装修风格列表页面【如图5.1显示的就是装修风格列表页面，此页面提供给管理员的功能有：查看装修风格、新增装修风格、修改装修风格、删除装修风格等。】
![alt text](images/image-3.png)

图5.2 主材管理页面【主材管理页面提供的功能操作有：新增主材，修改主材，删除主材操作。下图就是主材管理页面。】
![alt text](images/image-4.png)

图5.3 主材类型列表页面【主材类型管理页面显示所有主材类型，在此页面既可以让管理员添加新的主材类型，也能对已有的主材类型信息执行编辑更新，失效的主材类型信息也能让管理员快速删除。下图就是主材类型管理页面。】
